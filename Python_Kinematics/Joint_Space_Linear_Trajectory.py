...
def generate_trajectory(start_pos, end_pos, start_roll, end_roll,
    ...
    for t in t_values:
        ...
        for i in range(6):
            ...
            cur_angle = start_angles[i] + t * (end_angles[i] - start_angles[i])
            cur_angles.append(cur_angle)

        # interpolating roll, pitch, yaw
        ...
        t1, t2, t3, t4, t5, t6 = np.radians(cur_angles)
        ...
        if cur_angles[0] is not None:
            trajectory_data.append((cur_angles, cur_pos, cur_orientation, (cur_roll, cur_pitch, cur_yaw)))
        else:
...
if __name__ == "__main__":
    ...
    for angles, _, _, _ in full_trajectory:
    ...
    plt.plot(time, theta5_list, label="Theta5")
    plt.plot(time, theta6_list, label="Theta6")
