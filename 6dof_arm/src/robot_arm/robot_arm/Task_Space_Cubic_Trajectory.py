...
class TrajectoryNode(Node):
    ...
    def __init__(self):
        super().__init__('task_space_cubic_trajectory_node')
    ...
    def generate_trajectory(self, start_pos, end_pos, start_roll, end_roll,
        ...
        for t in t_values:
            ...
            cur_angles = self.inverse_kinematics(cur_pos, cur_orientation)
            ...
            if cur_angles[0] is not None:
                trajectory_data.append((cur_angles, cur_pos, cur_vel, cur_orientation, (cur_roll, cur_pitch, cur_yaw)))
            else:
