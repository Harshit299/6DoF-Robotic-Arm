...
class TrajectoryNode(Node):
    ...
    def __init__(self):
        super().__init__('joint_space_cubic_trajectory_node')
    ...
    def timer_callback(self):
        ...
        angles, pos, vel, acc, _, _ = self.full_trajectory[self.index]
    ...
    def extract_coords(self, t1, t2, t3, t4, t5, t6):
        ...
        # p6 (joint 4): move 16.875 mm forward from corner 2 towards joint 5
        forearm_vector = p7 - p5
        forearm_unit_vector = forearm_vector / np.linalg.norm(forearm_vector)
        # p6 = p5 + (forearm_unit_vector * 16.875)
        p6 = p5 + (forearm_unit_vector * 7.97)
        
        # p8 (joint 6): move 9.4 mm forward from joint 5 towards EE
        tool_vector = p9 - p7
        tool_unit_vector = tool_vector / np.linalg.norm(tool_vector)
        # p8 = p7 + (tool_unit_vector * 9.4)
